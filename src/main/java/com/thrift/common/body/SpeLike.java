...
public class SpeLike implements org.apache.thrift.TBase<SpeLike, SpeLike._Fields>, java.io.Serializable, Cloneable, Comparable<SpeLike> {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case LIKE_ID:
      if (value == null) {
        ...
        setLikeId((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(SpeLike other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLikeId()).compareTo(other.isSetLikeId());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SpeLike(");
    boolean first = true;
