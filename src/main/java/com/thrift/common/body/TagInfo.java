...
public class TagInfo implements org.apache.thrift.TBase<TagInfo, TagInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TagInfo> {
  ...
  public TagInfo setTagName(java.lang.String tagName) {
    this.tagName = tagName;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case TAG_TYPE:
      if (value == null) {
        ...
        setTagType((java.lang.Integer)value);
      }
      break;
    ...
    case TAG_COUNTS:
      if (value == null) {
        ...
        setTagCounts((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(TagInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTagType()).compareTo(other.isSetTagType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTagType()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTagCounts()).compareTo(other.isSetTagCounts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTagCounts()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TagInfo(");
    boolean first = true;
