...
public class AnswerInfo implements org.apache.thrift.TBase<AnswerInfo, AnswerInfo._Fields>, java.io.Serializable, Cloneable, Comparable<AnswerInfo> {
  ...
  public AnswerInfo setAnsContent(java.lang.String ansContent) {
    this.ansContent = ansContent;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ANS_ID:
      if (value == null) {
        ...
        setAnsId((java.lang.Integer)value);
      }
      break;
    ...
    case QUE_ID:
      if (value == null) {
        ...
        setQueId((java.lang.Integer)value);
      }
      break;
    ...
    case ANS_FLAG:
      if (value == null) {
        ...
        setAnsFlag((java.lang.Integer)value);
      }
      break;
    ...
    case ANS_LIKE:
      if (value == null) {
        ...
        setAnsLike((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(AnswerInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAnsId()).compareTo(other.isSetAnsId());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetQueId()).compareTo(other.isSetQueId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQueId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAnsFlag()).compareTo(other.isSetAnsFlag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAnsFlag()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAnsLike()).compareTo(other.isSetAnsLike());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAnsLike()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("AnswerInfo(");
    boolean first = true;
