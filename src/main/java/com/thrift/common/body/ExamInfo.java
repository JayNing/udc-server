...
public class ExamInfo implements org.apache.thrift.TBase<ExamInfo, ExamInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ExamInfo> {
  ...
  public ExamInfo setExamTitle(java.lang.String examTitle) {
    this.examTitle = examTitle;
    return this;
  }
  ...
  public java.lang.String getAssmContent() {
    return this.assmContent;
  }

  public ExamInfo setAssmContent(java.lang.String assmContent) {
    this.assmContent = assmContent;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case EXAM_TITLE:
      if (value == null) {
        ...
        setExamTitle((java.lang.String)value);
      }
      break;
    ...
    case ASSM_STATUS:
      if (value == null) {
        ...
        setAssmStatus((java.lang.Integer)value);
      }
      break;
    ...
    case ASSM_USER_ID:
      if (value == null) {
        ...
        setAssmUserId((java.lang.Integer)value);
      }
      break;
    ...
    case ASSM_CONTENT:
      if (value == null) {
        ...
        setAssmContent((java.lang.String)value);
      }
      break;
    ...
    case ASSM_TIME:
      if (value == null) {
        ...
        setAssmTime((java.lang.Long)value);
      }
      break;
    ...
    case ORGANISER_ID:
      if (value == null) {
        ...
        setOrganiserId((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(ExamInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetExamTitle()).compareTo(other.isSetExamTitle());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExamTitle()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAssmStatus()).compareTo(other.isSetAssmStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAssmStatus()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAssmUserId()).compareTo(other.isSetAssmUserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAssmUserId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAssmContent()).compareTo(other.isSetAssmContent());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAssmContent()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAssmTime()).compareTo(other.isSetAssmTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAssmTime()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOrganiserId()).compareTo(other.isSetOrganiserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOrganiserId()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ExamInfo(");
    boolean first = true;
