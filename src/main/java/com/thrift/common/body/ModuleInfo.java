...
public class ModuleInfo implements org.apache.thrift.TBase<ModuleInfo, ModuleInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ModuleInfo> {
  ...
  public java.lang.String moduleCode; // required
  ...
  public ModuleInfo setModuleName(java.lang.String moduleName) {
    this.moduleName = moduleName;
    return this;
  }
  ...
  public ModuleInfo setModuleCode(java.lang.String moduleCode) {
    this.moduleCode = moduleCode;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case MODULE_CODE:
      if (value == null) {
        ...
        setModuleCode((java.lang.String)value);
      }
      break;
  ...
  public int compareTo(ModuleInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetModuleCode()).compareTo(other.isSetModuleCode());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetModuleCode()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSubModelList()).compareTo(other.isSetSubModelList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubModelList()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ModuleInfo(");
    boolean first = true;
