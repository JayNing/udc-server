...
public class CommentInfo implements org.apache.thrift.TBase<CommentInfo, CommentInfo._Fields>, java.io.Serializable, Cloneable, Comparable<CommentInfo> {
  ...
  public java.lang.String comContent; // required
  ...
  public CommentInfo setComContent(java.lang.String comContent) {
    this.comContent = comContent;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case COM_FLAG:
      if (value == null) {
        ...
        setComFlag((java.lang.Integer)value);
      }
      break;
    ...
    case COM_CONTENT:
      if (value == null) {
        ...
        setComContent((java.lang.String)value);
      }
      break;
    ...
    case COM_TYPE:
      if (value == null) {
        ...
        setComType((java.lang.Integer)value);
      }
      break;
    ...
    case TARGET_ID:
      if (value == null) {
        ...
        setTargetId((java.lang.Integer)value);
      }
      break;
    ...
    case COM_LIKE:
      if (value == null) {
        ...
        setComLike((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(CommentInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCommentId()).compareTo(other.isSetCommentId());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetComFlag()).compareTo(other.isSetComFlag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetComFlag()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetComContent()).compareTo(other.isSetComContent());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetComContent()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetComType()).compareTo(other.isSetComType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetComType()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetComLike()).compareTo(other.isSetComLike());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetComLike()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CommentInfo(");
    boolean first = true;
