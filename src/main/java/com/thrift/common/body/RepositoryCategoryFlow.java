...
public class RepositoryCategoryFlow implements org.apache.thrift.TBase<RepositoryCategoryFlow, RepositoryCategoryFlow._Fields>, java.io.Serializable, Cloneable, Comparable<RepositoryCategoryFlow> {
  ...
  public java.lang.String flowName; // required
  ...
  public RepositoryCategoryFlow setFlowName(java.lang.String flowName) {
    this.flowName = flowName;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case FLOW_FLAG:
      if (value == null) {
        ...
        setFlowFlag((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(RepositoryCategoryFlow other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFlowName()).compareTo(other.isSetFlowName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFlowName()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFlowFlag()).compareTo(other.isSetFlowFlag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFlowFlag()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RepositoryCategoryFlow(");
    boolean first = true;
