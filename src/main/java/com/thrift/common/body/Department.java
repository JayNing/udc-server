...
public class Department implements org.apache.thrift.TBase<Department, Department._Fields>, java.io.Serializable, Cloneable, Comparable<Department> {
  ...
  public Department setDepartmentName(java.lang.String departmentName) {
    this.departmentName = departmentName;
    return this;
  }
  ...
  public Department setDescription(java.lang.String description) {
    this.description = description;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PARENT_DEP_ID:
      if (value == null) {
        ...
        setParentDepId((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(Department other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetParentDepId()).compareTo(other.isSetParentDepId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetParentDepId()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("Department(");
    boolean first = true;
