...
public class BorrowInfo implements org.apache.thrift.TBase<BorrowInfo, BorrowInfo._Fields>, java.io.Serializable, Cloneable, Comparable<BorrowInfo> {
  ...
  public java.lang.String lastEditUserId; // required
  ...
  public BorrowInfo(
    ...
    long lastEditTime,
    java.lang.String lastEditUserId,
  ...
  public BorrowInfo setCreateUserId(java.lang.String createUserId) {
    this.createUserId = createUserId;
    return this;
  }
  ...
  public java.lang.String getLastEditUserId() {
    return this.lastEditUserId;
  }

  public BorrowInfo setLastEditUserId(java.lang.String lastEditUserId) {
    this.lastEditUserId = lastEditUserId;
    return this;
  }
  ...
  public BorrowInfo setRemark(java.lang.String remark) {
    this.remark = remark;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case BORROW_ID:
      if (value == null) {
        ...
        setBorrowId((java.lang.Integer)value);
      }
      break;
    ...
    case BK_PK_ID:
      if (value == null) {
        ...
        setBkPkId((java.lang.Integer)value);
      }
      break;
    ...
    case BORROW_TIME:
      if (value == null) {
        ...
        setBorrowTime((java.lang.Long)value);
      }
      break;
    ...
    case BORROW_DAYS:
      if (value == null) {
        ...
        setBorrowDays((java.lang.Integer)value);
      }
      break;
    ...
    case GIVEBACK_TIME:
      if (value == null) {
        ...
        setGivebackTime((java.lang.Long)value);
      }
      break;
    ...
    case LAST_EDIT_USER_ID:
      if (value == null) {
        ...
        setLastEditUserId((java.lang.String)value);
      }
      break;
  ...
  public int compareTo(BorrowInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBorrowId()).compareTo(other.isSetBorrowId());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBkPkId()).compareTo(other.isSetBkPkId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBkPkId()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBorrowTime()).compareTo(other.isSetBorrowTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBorrowTime()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetBorrowDays()).compareTo(other.isSetBorrowDays());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBorrowDays()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGivebackTime()).compareTo(other.isSetGivebackTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("BorrowInfo(");
    boolean first = true;
